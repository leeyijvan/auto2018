...
public class BaseTest {
	public final static String DATAWebDriverEngine_ROOT = "data";

	String dataRestore=null;
	public  Checker check;
	public RobotExp robot;
	public static Properties conf = null;
	public final static String CONF_PATH = "conf/config.properties";//文件
	...
	public void screenShot() {
		...
		try {
			...
			FileUtils.copyFile(source_file, new File(dir_name + File.separator+ getDate() + ".jpg"));
		} catch (IOException e) {
			e.printStackTrace();
		}
	}
